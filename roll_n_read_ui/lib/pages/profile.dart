  ...
  Widget build(BuildContext context) {
    return ValueChangeObserver<bool>(
        ...
        builder: (_,charExists,__) => Container(
          child: charExists ? Container(
            child: Center(child: Column(
              mainAxisAlignment: MainAxisAlignment.center,
              children: [
                Text("Display Character"),
                TextButton(onPressed: () => setState(() {
                  Settings.setValue(CharCreator.keyCharCreated,false,notify: true);
...
class _CharCreatorState extends State<CharCreator> {
      ...
      onStepContinue: () {
        ...
        if(isLastStep){
          if(nameController.text.isNotEmpty){
            setState(() {
              character = Character(nameController.text, selectedClass,2, stats, savingThrows, skills);
              Settings.setValue(CharCreator.keyCharCreated, true, notify: true);
            });
          }
        ...
        content: Column(
          ...
          children: <Widget>[
            TextFormField(
              ...
              decoration: InputDecoration(labelText: "Name" ,hintText: "Grimgor Ironfist"),
            ...
            DropdownButton<ClassLabel>(
              ...
              items: ClassLabel.values.map<DropdownMenuItem<ClassLabel>>((ClassLabel value){
  ...
  Container savingThrowCheckbox(int index, String proficiency) {
    return Container(
      width: 320,
  ...
  Container skillProficiencyCheckbox(int index, String proficiency) {
    return Container(
      width: 320,
      child: CheckboxListTile(
        title: Text("$proficiency"),
        ...
        Stack(
          children: [
            ...
            CupertinoButton(
              ...
              child: Text("$profBonus",style: const TextStyle(
              ...
              onPressed: () => showCupertinoModalPopup(
                  ...
                  builder: (_) => SizedBox(
                    ...
                    child: CupertinoPicker(
                      ...
                      children: List.generate(10,(index) => Center(child: Text("$index",)), growable: false),
  ...
  Container statContainer(int index, String stat) {
    return Container(
                  ...
                  decoration: const BoxDecoration(
                    shape: BoxShape.rectangle,
                    image: DecorationImage(image: AssetImage("assets/images/StatBackground.png"),),
                    ...
                    children: [
                      ...
                      CupertinoButton(
                        padding: EdgeInsets.only(bottom: 0),
                          child: Text("${stats[index]}",style: const TextStyle(
                            fontFamily: "DragonHunter",
                            fontSize: 30,
                          ),),
                          onPressed: () => showCupertinoModalPopup(
                            ...
                            builder: (_) => SizedBox(
                              ...
                              child: CupertinoPicker(
                                ...
                                itemExtent: 50,
                                scrollController: FixedExtentScrollController(),
                                children: List.generate(20,(index) => Center(child: Text("${index+1}",)), growable: false),
                                onSelectedItemChanged: (int value) {
                                  setState(() {
                                    stats[index] = value+1;
                                  });
                      ...
                      Text("${((stats[index]-10.5)/2).round()}",style: const TextStyle(
                        fontFamily: "DragonHunter",
                        fontSize: 20,
                      ),)
                    ],
 ...
 * DropdownMenu<ClassLabel>(
    initialSelection: ClassLabel.paladin,
    ...
    (ClassLabel classVal) {
    return DropdownMenuEntry<ClassLabel>(
    value: classVal,
